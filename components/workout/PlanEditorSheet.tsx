...
export default function PlanEditorSheet({ plan, onClose, onSave }: PlanEditorSheetProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-black/85 p-4 pb-36 pt-8">
      <div className="w-full max-w-lg rounded-card bg-bg-card">
        <div className="sticky top-0 z-10 flex items-center justify-between border-b border-white/10 bg-bg-card px-5 py-4">
        ...
        <div className="max-h-[70dvh] space-y-5 overflow-y-auto px-5 py-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-btn bg-bg-surface px-4 py-3 text-sm outline-none focus:border-accent-green/50"
              autoFocus
            />
          </div>
        ...
        <div className="sticky bottom-0 flex gap-2 border-t border-white/10 bg-bg-card px-5 py-4">
          <button
            type="button"
            onClick={onClose}
